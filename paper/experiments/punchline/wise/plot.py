...
for suffix in ["s001", "s01", "s0001", "s05"]:
    ...
    match_p1000 = match(results_octree, lambda r: 'octree_0_1_9_p1000_' in r["name"] or r["name"].endswith('p1000'))
    ...
    plot_pareto(DATASET, match_btree+ full_scan, "plots/%s_pareto_btree9_%s.png" % (DATASET, suffix))
