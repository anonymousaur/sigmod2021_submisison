...
suffixes = ["btree9", "octree_0_1_9_p1000"]
mappings = [[(10,9), (11,9), (12,9)],
            [(5, 0), (6, 0), (7, 0), (8,0), (10,9), (11,9), (12,9)]]
...
def get_primary(spec, s):
    if s == "octree_0_1_2_9_p10000":
        spec.add("OctreeIndex {").add("10000").add("0 1 2 9").add("}")
    elif s == "octree_0_1_2_9_p1000":
        spec.add("OctreeIndex {").add("1000").add("0 1 2 9").add("}")
