...
suffixes = ["octree_0_2_8_p1000", "primary_8"]
...
linear_model_file = lambda m, a, s: \
        os.path.join(BASE_DIR, f"chicago_taxi_{a}_linear_{s}.{m[0]}_{m[1]}.model")
linear_outliers_file = lambda m, a, s: \
        os.path.join(BASE_DIR, f"chicago_taxi_{a}_linear_{s}.{m[0]}_{m[1]}.outliers")
